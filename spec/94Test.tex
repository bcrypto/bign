...
представлены примеры генерации одноразового личного ключа с помощью алгоритма,
установленного в~\ref{GENK}.
%
...
%
В качестве~$h$ используется функция, заданная алгоритмом~\algname{belt-hash}.
